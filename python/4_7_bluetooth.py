...
developer = raw_input('are you rushi or hannelle or the best? : ')
...
with open(savepath+file_name+'.csv', 'wb') as csvfile:
    print 'Saving Data...'
    datacnt = 0
    while(datacnt<len(accel_Time)):
        dataWriter = csv.writer(csvfile)
        dataWriter.writerow([accel_Time[datacnt]]+[accZ[datacnt]]+[cut_signal[datacnt]])
        datacnt = datacnt + 1          
